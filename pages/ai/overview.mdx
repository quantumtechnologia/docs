...
```bash
# Claude
claude mcp add quantumpay --scope user --transport http https://api.quantumpay.com.br/mcp
```
...
// VS Code (settings.json)
{
  "mcp": {
    "servers": {
      "quantumpay": {
        "type": "http",
        "url": "https://api.quantumpay.com.br/mcp"
      }
    }
  }
}
...
```bash
# OpenAI Codex
codex mcp add --name quantumpay --url https://api.quantumpay.com.br/mcp
```
...
<CardGroup cols={2}>
  <Card title="Servidor MCP" icon="server" href="https://api.quantumpay.com.br/mcp">
